        ...
        <div className='w-[50%] border-l border-r border-gray-200'>
            <div>
                <div className='flex items-center py-2'>
                    <Link to="/" className='p-2 rounded-full hover:bg-red-100 hover:cursor-pointer'>
                ...
                <div className='text-right m-4'>
                    {
                        profile?._id === user?._id ? (
                            <button className='px-4 py-1 hover:bg-red-100 rounded-full border border-gray-400'>
                                Edit Profile
                            </button>
                        ) : (
                            <button onClick={followAndUnfollowHandler} className={`px-4 py-1 ${user.following.includes(id) ? 'bg-red-500 text-white' : 'bg-red-100 text-black'} rounded-full`}>
